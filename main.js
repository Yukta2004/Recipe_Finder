...
// Function to display recipes in a stacked column layout
function displayRecipes(recipes) {
    const container = document.getElementById("recipe-container");
    container.innerHTML = ""; // Clear previous results

    container.className = "flex flex-col items-center w-full"; // Ensuring column layout
    ...
    recipes.forEach(recipe => {
        ...
        card.innerHTML = `
            ...
            <div class="mt-4 sm:mt-0 sm:ml-6 w-full">
                ...
                <p class="text-gray-700"><strong>Instructions:</strong> ${recipe.TranslatedInstructions.substring(0, 150)}...</p>
            </div>
        `;
